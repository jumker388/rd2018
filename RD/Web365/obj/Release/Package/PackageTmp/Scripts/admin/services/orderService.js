...
web365app.factory('orderService', ['$q', '$http', function ($q, $http) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/Order/Action', obj, {
